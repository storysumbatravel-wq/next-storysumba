...
CREATE TABLE `destinations` (
    ...
    INDEX `destinations_itineraryId_fkey`(`itineraryId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `flight_infos` (
    ...
    INDEX `flight_infos_tripId_fkey`(`tripId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `hotel_infos` (
    ...
    INDEX `hotel_infos_tripId_fkey`(`tripId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `trip_includes` (
    ...
    INDEX `trip_includes_tripId_fkey`(`tripId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `trip_excludes` (
    ...
    INDEX `trip_excludes_tripId_fkey`(`tripId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `trip_tips` (
    ...
    INDEX `trip_tips_tripId_fkey`(`tripId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
